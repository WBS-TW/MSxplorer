...
formula <- c("C8H11NO", "C6H9N4", "C3H11N3O3")
hit <- HRMF(file = "D://R_projects//MSxplorer//data//2-Methoxy-5-methylaniline_C8H11NO.msp", formula = formula, IR_RelAb_cutoff = 1, intensity_cutoff = 100000, return_detailed_list = FALSE)
