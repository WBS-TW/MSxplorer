...
PFSA_frags <- data.frame(name = c("FSO3", "SO3", "PFOS"), mz = c(98.9552, 79.9558, 498.9300), ms_level = c("ms2", "ms2", "ms1"))
plotTopMS1Peaks(filepath = fl, flagfragments = PFSA_frags, numTopIons = 10)
