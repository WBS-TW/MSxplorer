...
formula <- c("CHCl3", "C8H11NO","C10H3N", "C6H9N4", "C3H11N3O3", "C7H9N2O", "CH7N5O3")
hit <- HRMF(file = "D://R_projects//MSxplorer//data//2-Methoxy-5-methylaniline_C8H11NO.msp", mass_accuracy = 5, formula = formula, select_compound = 1,  IR_RelAb_cutoff = 1, intensity_cutoff = 10000, return_detailed_list = FALSE)
